...
public class SendEmail {
	...
	private final String MessageFooter = "\n\nWe believe that it is in your child's best interests that you, their guardian, "
			+ "are kept up to date with their progress in class. However, f you wish to stop receiving these emails please contact "
			+ "me directly.\n\nKind Regards,\n";
	Alert alert;
	public SendEmail() {
	}
	public SendEmail(String receiverEmail, String pupilName, String teacherName, String progressReport) {
		super();
	...
	public void send() {
		...
		String messageBody = MessageHeader + pupilName + MessageHeader2 + progressReport + MessageFooter + teacherName;
